local ITEM_ID = 2519 -- Replace with the ID of the item you want to check for
local ITEM_COUNT = 1 -- Replace with the number of items you want to create if they're not present
local POSITION = Position(1003, 1001, 8) -- Replace with the position you want to check
