local ITEM_ID = 1956 -- Replace with the ID of the item you want to check for
local ITEM_COUNT = 1 -- Replace with the number of items you want to create if they're not present
local POSITION = Position(1010, 998, 10) -- Replace with the position you want to check
